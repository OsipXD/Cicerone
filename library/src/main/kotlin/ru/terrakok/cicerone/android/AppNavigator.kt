...
/**
 * Extends [FragmentNavigator] to allow open new or replace current activity.
 *
 * This navigator DOESN'T provide full featured Activity navigation, but can ease Activity
 * start or replace from current navigator.
 *
